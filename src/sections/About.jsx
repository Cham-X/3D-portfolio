    ...
    return (
        <section className="c-space my-20" id="about">
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                    ...
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">
                                With {currentYear} years of Experience,I have honed my skills in frontend and backend development,Fullstack Developer.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        <img src="assets/IMG-20240915-WA0007.jpg" alt="grid-2" className="w-full sm:h-[276px] h-fit object-contain" />
